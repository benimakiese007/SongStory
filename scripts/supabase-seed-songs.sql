...
VALUES
  ...
  ('black', 'Black', 'dave', 'Rap', 2019, 'images/covers/black-cover.webp', ARRAY['Identité', 'Social', 'UK'], 'Un manifeste puissant sur l''identité noire, extrait du chef-d''œuvre Psychodrama.', 'songs/dave/black.html')
