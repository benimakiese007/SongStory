...
// FULL LYRICS BASED ON USER MESSAGE
const blocks = [
    {
        time: 0,
        display_order: 0,
    ...
    },
    {
        ...
        analysis: "Drake ridiculise l'image 'gangsta' de Kendrick. Il utilise des termes comme **DP** et **PC** (protection) pour dire que Kendrick n'est qu'un civil. Il mentionne aussi Metro Boomin et une affaire d'infidélité supposée."
    },
    {
        time: 50,
        display_order: 20,
        ...
        analysis: "Attaque sur l'intégrité de Kendrick. Drake l'accuse d'être un faux activiste ('make-believe') et d'avoir des insécurités raciales en critiquant les fréquentations de Drake alors que lui-même est avec une femme métisse ('mixed queen')."
    },
    {
        time: 80,
        display_order: 30,
        ...
        analysis: "Drake compare Kendrick à Bobby Brown (suggérant des abus envers Whitney Alford) et lance l'allégation choc : Dave Free serait le père biologique d'un des enfants de Kendrick. Il parodie ensuite le style 'club' de Kendrick ('Shake that ass')."
    },
    {
        time: 140,
        display_order: 40,
        ...
        analysis: "Drake s'amuse sur le nom 'Free' (Dave Free) et ridiculise la taille de Kendrick ('mini Drac'). Il mentionne que le conflit a commencé quand The Weeknd ('Abel') a commencé à lancer des piques subtiles ('serenade')."
    },
    {
        time: 180,
        display_order: 50,
        ...
        analysis: "Drake devient plus sérieux. Il s'en prend à l'entourage de Kendrick et de The Weeknd. Il se moque du 'falsetto' d'Abel et traite Kendrick de 'souvenir de boutique cadeau', suggérant qu'il n'est plus qu'une relique."
    },
    {
        time: 220,
        display_order: 60,
        ...
        analysis: "Attaque féroce contre Rick Ross. Drake se moque de ses rumeurs de chirurgie et utilise l'Ozempic comme métaphore de sa jalousie. Il rappelle le passé de maton (COR) de Ross pour discréditer sa crédibilité de rue."
    },
    {
        time: 270,
        display_order: 70,
        ...
        analysis: "Drake continue d'égréner sa liste de cibles. Il utilise l'imagerie du van de GKMC pour dire qu'il va attaquer Kendrick sur son propre terrain. Il continue d'insulter la base de fans de The Weeknd."
    },
    {
        time: 320,
        display_order: 80,
        ...
        analysis: "Drake accuse The Weeknd d'utiliser son argent pour 'acheter' la loyauté de gens de la rue. Il bifurque ensuite sur ASAP Rocky (Rakim), se moquant de son focus sur la mode au détriment de sa musique."
    },
    {
        time: 370,
        display_order: 90,
        ...
        analysis: "Drake insinue que Rocky n'est pertinent que lorsqu'il a des enfants avec Rihanna. Il mentionne Future (Pluto) et Metro Boomin (Leland Wayne), exprimant sa déception face à cette trahison."
    },
    {
        time: 420,
        display_order: 100,
        ...
        analysis: "Drake affirme que Kendrick a été piégé par les autres pour participer à ce beef. Il clame que le succès récent de Kendrick est dû à l'écriture de Baby Keem et se vante de ses propres succès commerciaux."
    },
    {
        time: 450,
        display_order: 110,
        ...
        analysis: "L'apogée du morceau. Drake se voit déjà vainqueur. Il attaque ensuite l'oncle de Kendrick (un homme transgenre dont Kendrick parle dans Auntie Diaries) pour le ridiculiser personnellement."
    },
    {
        time: 490,
        display_order: 120,
        ...
        analysis: "Drake défie Kendrick sur son propre terrain (West Coast). Il mentionne Pharrell et accuse Kendrick d'avoir peur de lui juridiquement en contactant la succession de Tupac pour faire supprimer son morceau précédent."
    },
    {
        time: 520,
        display_order: 130,
        ...
        analysis: "Drake remet en question la loyauté du label de Kendrick (TDE/Top Dawg), affirmant à nouveau que le père de Kendrick a été volé. Il dit que tout est déjà fini pour Kendrick."
    },
    {
        time: 550,
        display_order: 140,
        ...
        analysis: "Drake s'approprie le succès du beef et se moque du 'Big Three'. Il suggère que Kendrick est complexé par sa couleur de peau (colorisme) et qu'il évite de s'afficher avec des métis comme lui."
    },
    {
        time: 580,
        display_order: 150,
        ...
        analysis: "Drake accuse Kendrick de violence conjugale ('self-defense') et remet en question la stabilité de son couple avec Whitney, notant qu'ils sont fiancés depuis 2015 sans s'être mariés."
    },
    {
        time: 610,
        display_order: 160,
        ...
        analysis: "Drake continue sur le thème MJ/Prince, disant que Kendrick est Mike car il voulait 'devenir blanc'. Il mentionne aussi J. Cole ('Jermaine') et suggère que Kendrick voulait l'écarter."
    },
    {
        time: 650,
        display_order: 170,
        ...
        analysis: "La conclusion. Drake affirme que Kendrick a une équipe de 'crisis management' pour cacher ses abus. Le morceau finit sur une note de victoire totale... qui sera de courte durée."
    }
];

async function injectFullContent() {
    console.log('Cleaning existing content...');
    await supabase.from('song_contents').delete().eq('song_id', songId);

    console.log(`Injecting ${blocks.length} analysis blocks...`);
    ...
    if (error) {
        ...
        console.log('✅ Success! ALL lyrics and analysis for Family Matters are now LIVE.');
    }
}
